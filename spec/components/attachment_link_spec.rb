...
describe "Attachment Link", type: :view do
  ...
  it "renders an attachment link" do
    render_component(attachment: { title: "Attachment", url: "https://publishing-platform.co.uk/attachment" })
    assert_select ".gem-c-attachment-link"
    assert_select "a[href='https://publishing-platform.co.uk/attachment']", text: "Attachment"
  end
