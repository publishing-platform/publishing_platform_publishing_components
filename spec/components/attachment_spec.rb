...
describe "Attachment", type: :view do
  ...
  it "renders an attachment" do
    render_component(attachment: { title: "Attachment", url: "https://www.publishing-platform.co.uk/attachment" })
    assert_select ".gem-c-attachment"
    assert_select "a[href='https://www.publishing-platform.co.uk/attachment']", text: "Attachment"
  ...
  it "shows reference details on the first metadata line if provided" do
    ...
    assert_select ".gem-c-attachment__metadata:nth-of-type(1)", text: "Ref: ISBN 978-1-5286-1173-2, 2259"
  end
  ...
  it "shows 'View online' preview link if preview_url is provided" do
    ...
    assert_select ".gem-c-attachment__metadata", text: "View online"
  end
  ...
  it "displays a custom heading level if heading_level is specified" do
    ...
    assert_select "h3.gem-c-attachment__title", text: "Attachment"
  end
  ...
  it "defaults to h2 if heading_level is not specified" do
    ...
    assert_select "h2.gem-c-attachment__title", text: "Attachment"
  end
  ...
  it "accepts margin_bottom" do
    ...
    assert_select '.gem-c-attachment[class~="mb-1"]'

    render_component(attachment: { title: "Attachment", url: "https://gov.uk/attachment" }, margin_bottom: 4)
    assert_select '.gem-c-attachment[class~="mb-4"]'
  end

  it "defaults to margin_bottom of 3" do
    render_component(attachment: { title: "Attachment", url: "https://gov.uk/attachment" })
    assert_select '.gem-c-attachment[class~="mb-3"]'
  end
end
