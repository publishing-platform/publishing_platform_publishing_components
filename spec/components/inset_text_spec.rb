...
describe "Inset text", type: :view do
  ...
  it "renders inset text" do
    ...
    assert_select(".gem-c-inset-text", text: "It can take up to 8 weeks to register a lasting power of attorney if there are no mistakes in the application.")
  end
  ...
  it "renders a block" do
    ...
    assert_select(".gem-c-inset-text h2#heading", text: "To publish this step by step you need to")
    assert_select(".gem-c-inset-text a[href='/foo']", text: "Check for broken links")
  end
  ...
  it "renders only the text if both text and block are provided" do
    ...
    assert_select(".gem-c-inset-text", text: "Bar")
    assert_select(".gem-c-inset-text p#foo", false, "Block should not have rendered")
  end
  ...
  it "applies custom margin bottom" do
    ...
    assert_select(".gem-c-inset-text.mb-5", text: "margin!")
  end
end
